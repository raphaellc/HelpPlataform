...
To update the database use this command from the Web project folder (replace `HelpPlatform` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../HelpPlatform.Infrastructure/HelpPlatform.Infrastructure.csproj -s HelpPlatform.Web.csproj
```
