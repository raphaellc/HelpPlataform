...
using HelpPlatform.Core.ProjectAggregate;
using HelpPlatform.Core.Services;
using HelpPlatform.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace HelpPlatform.UnitTests.Core.Services
{
